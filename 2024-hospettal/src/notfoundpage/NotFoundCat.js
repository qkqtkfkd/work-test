...
import cat from "../assets/gallery/404페이지_02.jpg";
  ...
  return (
    <Container>
      ...
      <div className={styles.find}>
        ...
        <figure>
          <img className={styles.image} src={cat} alt="고양이" />
        </figure>
        ...
        <div className={styles.animal}>
          ...
          <div className={styles.infoBox}>
            ...
            <div className={styles.container2}>
              ...
              <p className={styles.animalInfo}>코리안숏헤어</p>
            </div>
            <div className={styles.container2}>
            ...
            <div className={styles.container2}>
              ...
              <p className={styles.animalInfo}>온순함, 배에 점이 있음</p>
            </div>
          </div>
        </div>
