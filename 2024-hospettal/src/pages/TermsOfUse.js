...
function TermsOfUse() {
  return (
    <div className="text-container" style={{ fontFamily: "NotoSans" }}>
      ...
      <h4>제1조(목적)</h4>
      <p>
        이 약관은 Hospetal 회사(전자상거래 사업자)가 운영하는 사이버 몰(이하
      ...
      <h4>제2조(정의)</h4>
      <p>
        ① “몰”이란 Hospetal 회사가 재화 또는 용역(이하 “재화 등”이라 함)을
      ...
      <p>
        ...
        2회 이상 반복되거나 30일 이내에 그 사유가 시정되지 아니하는 경우 “몰”은
        회원자격을 상실시킬 수 있습니다.
      </p>
      <p>
      ...
      <p>3) 제공하는 개인정보의 항목,</p>
      <p>
        4) 개인정보를 제공받는 자의 개인정보 보유 및 이용기간을 구매자에게
      ...
      <p>
        ...
        받아야 합니다. (동의를 받은 사항이 변경되는 경우에도 같습니다.) 다만,
